<?php
  ...
  if(isset($_SESSION["title"])){
    if($_SESSION["title"] == "manager" || $_SESSION["title"] == "barista"){
        header("location: employees/employeeHome.php");
        exit;
    }
  }
...
<div id = "main">
  <div class="col-12 col-s-12">
    ...
    <!-- <button class = "loginButton" onclick="window.location.href='employees/login.php';"> Login</button> -->
  </div>
</div>
