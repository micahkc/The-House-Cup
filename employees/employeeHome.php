...
<div class="col-12">
    <button class="btn" onclick="window.location.href='orders.php';">Orders</button><br><br>
    <button class="btn" onclick="window.location.href='inventory.php';">Inventory</button><br><br>
    <button class="btn" onclick="window.location.href='merchandise.php';">Merchandise</button><br><br>
    <button class="btn" onclick="window.location.href='changeMenu.php';">Edit Menu</button><br><br>
    <button class="btn" onclick="window.location.href='stats.php';">Statistics</button><br><br>


  <?php if(isset($_SESSION['title']) && ($_SESSION['title']=="manager")) { ?>

    <!DOCTYPE html> 
    <html> 
    <body>  
     <button class="btn" onclick="window.location.href='addEmployee.php';">Add Employee</button>
    </body> 
    </html>
