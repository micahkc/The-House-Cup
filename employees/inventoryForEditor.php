...
<div>
  ...
  <?php 
    ...
    $query = "SELECT description, available, category, caffinated, lactose, sugarFree FROM(((Ingredients LEFT OUTER JOIN Caffine ON Ingredients.itemID = Caffine.itemID)LEFT OUTER JOIN Lactose ON Ingredients.itemID = Lactose.itemID)LEFT OUTER JOIN SugarFree ON Ingredients.itemID = SugarFree.itemID) WHERE category = 'flavoring'";
