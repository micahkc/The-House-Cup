...
<div class="col-12">
  <h2>Drinks Ordered</h2>
</div>
<div class="col-12">
  <div class="col-3"><h2>Spring</h2></div>
  <div class="col-3"><h2>Summer</h2></div>
  <div class="col-3"><h2>Fall</h2></div>
  <div class="col-3"><h2>Winter</h2></div>
</div>
...
<div class="col-12">
  <div class="col-3">
    ...
    $query = "SELECT COUNT(orderNum)
              FROM SeasonalOrders
              WHERE season='spring'";
    $spring = $conn->query($query);

    
    $row = $spring->fetch_assoc();
    echo"<h2>".$row['COUNT(orderNum)']."</h2>";
  ?>
</div>
  <div class="col-3">
    <?php
    ...
    $query = "SELECT COUNT(orderNum)
              FROM SeasonalOrders
              WHERE season='summer'";
    $summer = $conn->query($query);

    
    $row = $summer->fetch_assoc();
    echo"<h2>".$row['COUNT(orderNum)']."</h2>";
  ?>
</div>
  <div class="col-3">
    ...
    $query = "SELECT COUNT(orderNum)
              FROM SeasonalOrders
              WHERE season='fall'";
    $fall = $conn->query($query);

    
    $row = $fall->fetch_assoc();
    echo"<h2>".$row['COUNT(orderNum)']."</h2>";
  ?>
</div>
  <div class="col-3">
    ...
    $query = "SELECT COUNT(orderNum)
              FROM SeasonalOrders
              WHERE season='winter'";
    $winter = $conn->query($query);

    
    $row = $winter->fetch_assoc();
    echo"<h2>".$row['COUNT(orderNum)']."</h2>";
  ?>
</div>
</div>
