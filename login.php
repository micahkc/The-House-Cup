...
<body>
    <div id="main" class="col-12">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="">
                ...
                <input type="submit" class="btn" id="loginBtn" value="Login" style="background-color:#ff8000;">
            </div>
    ...
    <div class="col-12" id="buttonRow">
        <button class="btn" onClick="window.location.href='newCustomerAccount.php';">Create Account</button> <br><br>
        <button class="btn" onClick="window.location.href='forgotPassword.php';">Forgot Password</button> <br><br>
        <button class="btn" onClick="window.location.href='changePassword.php';">Change Password</button> <br><br>
